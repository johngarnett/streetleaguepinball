...
// TODO: Map is an actual javascript prototype already. We should probably rename ours.
Map.prototype = {
  constructor: Map,
...
var _shadows = new Map(DATA_FOLDER + '/.shadows');
var _tokens  = new Map(DATA_FOLDER + '/.tokens');
_shadows.load();
_tokens.load();
...
function testShadows() {
  ...
  shadows.filename = DATA_FOLDER + '/test_shadows';

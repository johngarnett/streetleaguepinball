...
const debug = () => {}; // Or console.log when needed.
...
const TOKEN_DIR = CREDENTIALS_FOLDER;
...
function send({to, from, subject, message}) {
  //TODO: We don't have Google API account yet.  So nothing to do until we get that.
  /*
  return new Promise((resolve, reject) => {
...
/*
TODO: uncomment and fix when we start sending email
...
FYI: DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
